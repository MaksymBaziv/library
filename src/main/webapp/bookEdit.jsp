...
<div class="container">
    <form action="bookEdit" method="post" enctype="multipart/form-data">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-10">
                <input value="${book.name}" type="text" class="form-control" name="name" id="name" placeholder="Name">
            </div>
        </div>
        <div class="form-group row">
            <label for="pages" class="col-sm-2 col-form-label">Pages</label>
            <div class="col-sm-10">
                <input value="${book.pages}" type="text" class="form-control" name="pages" id="pages"
                       placeholder="Pages">
            </div>
        </div>
        <div class="form-group row">
            ...
            <div class="col-sm-10">
                <input value="${book.yearOfPublication}" type="text" class="form-control" name="yearOfPublication"
